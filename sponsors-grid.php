...
<!-- Filter -->
<script src="js/sponsors-grid.js"></script>
...
<header>
  ...
  <span data-reveal-id="BecomeASponsorModal" onClick="_gaq.push(['_trackEvent', 'SponsorsPage', 'ModalOpen', 'BecomeASponsor']);"><button>Become a Sponsor</button></span>
</header>
<!-- END Header -->

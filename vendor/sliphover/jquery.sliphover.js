...
;(function($, window, document, undefined) {
    ...
    var pluginName = "sliphover",
        defaults = {
            target: '.Square', //the element that the overlay will attach to
            ...
            fontColor: '#fff',
            textAlign: 'left', //display the caption left, center or right
            verticalMiddle: false, //display the caption vertical middle or not
            backgroundColor: 'rgba(16,106,181,1)', //specify the background color and opacity using rgba
            reverse: false, //reverse the direction
            height: '100%', //specify the height of the overlay
            withLink: false //if image is wraped with a link the overlay will be clickable, set false to disable click
        };
    ...
    SlipHover.prototype = {
        ...
        createContainer: function($element) {
            ...
            var $overlayContainer = $('<div>', {
                ...
                zIndex: zIndex == +zIndex ? (zIndex + 1) : 450 // if the z-index of the target is not number then use 999
            });

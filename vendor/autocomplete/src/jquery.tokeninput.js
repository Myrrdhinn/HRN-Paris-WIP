...
function start_search() {
  var selP = $("#SearchField").val();	
  
  if (typeof selP != "undefined" && selP != '') {
	   var selectedParams = selP.split(",");
			 ...
			 $("#FilteredGrid .CategoryContainer").empty();
			   ...
			   $(".Sponsor").each(function() {
				  ...
				  if (typeof current != "undefined" && current != ""){
						  var tags = current.split(",");
							...
							$.each(tags, function(index, sponsorTag) {
									   ...
									   $.each(selectedParams, function(ind, selectedTag) {
										   var search_id = selectedTag.substring(3, selectedTag.length);
										   var tag_part = selectedTag.substring(0, 2);
										   
										   if(tag_part == 'sc'){
										 
												if (sponsorTag == search_id) {
												   sponsors[i][0]++;
				  ...
				  //Check if there is a direct sponsor search
				   $.each(selectedParams, function(ind, selectedTag) {
						 var search_id = selectedTag.substring(3, selectedTag.length);
						 var tag_part = selectedTag.substring(0, 2);
						   ...
						   if(tag_part == 'sn'){
								 ...
								 if (sponsornum == search_id) {
									 sponsors[i] = new Array; //s[i] is one  /  sponsor s[i][s] - that one sponsors one filter tag 
									 sponsors[i][0] = 20; //to bump up that sponsor to the front
									 sponsors[i][1] = thisSponsor; 
									 sponsors[i][2] = sponsornum;
									 i++;
								  }
			 ...
			 var finalList = getDistinctArrayInput(sponsors);
 ...
 } //if selectedParams not empty end
}

function getDistinctArrayInput(arr) {

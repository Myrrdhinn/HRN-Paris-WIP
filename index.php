...
$(document).scroll(function() {
  ...
  if (y > 200) {
	...
	$("#HRTechDesktopLogo").css("margin-right", "8.33333vw");
...
<nav id="DesktopMenu">
	...
	<ul id="DesktopMenuList">
        ...
        <a href="tickets" title="Get Tickets" onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Tickets']);"><li id="DesktopGetTickets" class="DesktopMenuItem TransparentDesktopMenuItem"><i class="fa fa-ticket"></i> GET TICKETS</li></a>
    </ul>
    ...
    <div id="disruptHRSlideContainer">
        <div class="SlideInnerContainer">       
             ...
             <span class="VenueAndDate FontLato"><strong>Palais des Congrès</strong><br>27-28 October 2015</span>
              ...
              <p>disruptHR is the evolution of 3 years of our successful start-up competition and this year includes a new standing exhibition and pitching stage.<span class="HiddenTextOnMobile"><br><br>
...
<section id="SocialLove">
 ...
 <div id="SocialWrapper"><script async src="https://d36hc0p18k1aoc.cloudfront.net/public/js/modules/tintembed.js"></script><div class="tintup" data-id="hrtechworld" data-columns="" data-expand="true"    data-infinitescroll="true"  style="height:26vw;width:100%;"></div></div>
...
<!-- Venue --> 
<section id="Venue">
	<h1 class="BlueText" id="VenueHeadline">Venue</h1>
    <div id="VenueInnerContainer">
      <div id="VenueInfo">
          <img id="Pin" class="PinAnimation" src="img/mainpage/venue/pin.png" alt="Pin" />

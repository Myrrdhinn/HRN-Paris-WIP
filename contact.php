...
<title>HR Tech World Congress | Contact</title>

<!-- Open Graph data -->
<meta property="og:site_name" content="HR Tech World Congress"/>
<meta property="og:title" content="HR Tech World Congress | Contact"/>
<meta property="og:description" content="The fastest growing HR event in the world! Paris October 24 - 25"/>
<meta property="og:url" content="http://hrtechcongress.com/contact">
...
<header>
   <div id="HeaderInnerContainer">
       <h1 class="FontRaleway">Get in Touch</h1>
...
<!-- Contact Members -->
    <div id="ContactMembersContainer" class="FontLato">
      <div class="ContactMember">
        ...
        <p>Steve George</p>
        <p class="ContactPhoneNumber">+36 1 201 1469 /213</p>
      </div>
      <div class="ContactMember">
        ...
        <p>Peter Russell</p>
        <p class="ContactPhoneNumber">+33 648 923 260</p>
      </div>
      <div class="ContactMember">
        ...
        <p>Viktoria McCann</p>
        <p class="ContactPhoneNumber">+36 1 201 1469 /209</p>
      </div>
      <div class="ContactMember">
        ...
        <p>Claire Quito</p>
        <p class="ContactPhoneNumber">+36 1 201 1469 /216</p>
      </div>
    </div>
<!-- END Contact Members -->
...
<!-- Form Section -->
    <div id="ContactFormSection" class="FontLato">
      <!-- HRN Contact info -->
      <div id="ContactInfoContainer">
        <div id="ContactAddress">
          <div class="ContactIcon"><i class="fa fa-pencil"></i></div>
          <p class="ContactText">HRN EUROPE<br />
            Millenáris Irodaház<br />
            39. Lövoház utca,<br />
            1024 Budapest, Hungary </p>
        </div>
        <div id="ContactGen">
          <div class="ContactIcon"><i class="fa fa-phone"></i></div>
          <p class="ContactText">General Inquiries<br />
            +36 1 201 1469<br />
            UK &amp; Ireland Number<br />
            +44 20 34 689 689 </p>
        </div>
        <div id="ContactMail">
          <div class="ContactIcon"><i class="fa fa-envelope"></i></div>
          <p class="ContactText">hrn@hrneurope.com </p>
        </div>
      </div>
      <!-- END HRN Contact info -->
      <!-- Contact Form Container -->
      <div id="ContactFormContainer">
        <!-- BEGINNING of : CONTACT FORM -->  
        <form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST">
          <input type=hidden name="oid" value="00DD0000000nwgk">
          <input type=hidden name="retURL" value="http://hrtechcongress.com#ThankYouContactModal">
            <div id="LeftInputFields">
              ...
              <select style="display:none;"   id="lead_source" name="lead_source">
                <option selected="selected" value="HRTechParis2015-ContactForm">HRTechParis2015-ContactForm</option>
              </select>
            </div>
            <div id="RightInputFields">
              <textarea placeholder="Message" name="description" class="FontLato"></textarea>
            </div>
              <input onClick="_gaq.push(['_trackEvent', 'ContactForm', 'FromSubmission', 'InquirySent']);" type="submit" class="FontRaleway" name="submit" value="Send">
        </form>
        <!-- END of : CONTACT FORM -->
      </div>
...
<div id="DownloadBrochureModal" class="reveal-modal" data-reveal> <a class="close-reveal-modal">&#215;</a>
  ...
  <form action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST">
    <input type=hidden name="oid" value="00DD0000000nwgk">
    <input type=hidden name="retURL" value="http://hrtechcongress.com/contact.php#ThankYouBrochureModal">
    <input required placeholder="First Name *"  id="first_name" maxlength="40" name="first_name" size="20" type="text" />
    <input required placeholder="Last Name *" id="last_name" maxlength="80" name="last_name" size="20" type="text" />
    <input required placeholder="Email Address *" id="email" maxlength="80" name="email" size="20" type="text" />
    <input required placeholder="Phone Number *" id="phone" maxlength="40" name="phone" size="20" type="text" />

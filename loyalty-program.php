...
<title>HR Tech World Congress | Loyalty Program</title>

<!-- Open Graph data -->
<meta property="og:site_name" content="HR Tech World Congress"/>
<meta property="og:title" content="HR Tech World Congress | Loyalty Program"/>
<meta property="og:description" content="The fastest growing HR event in the world! Paris October 24 - 25"/>
<meta property="og:url" content="http://hrtechcongress.com/loyalty-program">
...
<link rel="stylesheet" href="css/loyalty-program.css" />
...
<header>
    ...
    <p>Attend with colleagues and benefit from our exclusive corporate membership and loyalty program</p>
    <h2>The HRN Loyalty Program offers you and your colleagues significant cost savings
		while gaining exclusive member privileges.</h2>
</header>
<!-- END Header -->
<!-- Pricing Tables -->
<section id="PricingTables">
	<h2 class="InvisibleHeadline">Loyalty Program Pricing Tables</h2>
    
    <!-- Diamond -->
    <div class="Table">
    	<h3 class="Category">DIAMOND</h3>
        <div class="Details">
        	<i class="fa fa-ticket"></i>
            <p>20 tickets</p>
            <h4 class="Price OldPrice">€ 23,800</h4>
            <p>30% off</p>
            <h4 class="Price NewPrice">€ 16,600</h4>
            <p>save € 7,200</p>
        </div>
        <ul class="Benefits">
            ...
            <li>Exclusive Main-Stage Seating</li>
            <li>Dedicated Meeting and Networking Areas</li>
            <li>Priorty meetings & demos  with exhibitors</li>
            <li>Branding opportunities</li>
            <li>Meet keynote speakers in the VIP lounge: <strong>3</strong></li>
            <li>Tickets to the HR Tech World Party, Paris: <strong>20</strong></li>            
        </ul>
    </div>
    <!-- END Diamond -->
    
    <!-- Platinum -->
    <div class="Table" id="Diamond">
    	<h3 class="Category "id="MostPopular">MOST POPULAR</h3>
    	<h3 class="Category">PLATINUM</h3>
        <div class="Details">
        	<i class="fa fa-ticket"></i>
            <p>14 tickets</p>
            <h4 class="Price OldPrice">€ 16,600</h4>
            <p>25% off</p>
            <h4 class="Price NewPrice">€ 12,450</h4>
            <p>save € 4,150</p>
        </div>
        <ul class="Benefits">
        	<li>Fast Track Registration</li>
            ...
            <li>Priorty meetings & demos  with exhibitors</li>
            <li>Branding opportunities</li>
            <li>Meet keynote speakers in the VIP lounge: <strong>2</strong></li>
            <li>Tickets to the HR Tech World Party, Paris: <strong>14</strong></li>            
        </ul>
    </div>
    <!-- END Platinum -->
    ...
    <!-- Gold -->
    <div class="Table">
    	<h3 class="Category">GOLD</h3>
        <div class="Details">
        	<i class="fa fa-ticket"></i>
            <p>8 tickets</p>
            <h4 class="Price OldPrice">€ 9,250</h4>
            <p>20% off</p>
            <h4 class="Price NewPrice">€ 7,400</h4>
            <p>save € 1,850</p>
        </div>
        <ul class="Benefits">
            <li>Key Account Management</li>
            ...
            <li>Priorty meetings & demos  with exhibitors</li>
            <li>Branding opportunities</li>
            <li>Meet keynote speakers in the VIP lounge: <strong>1</strong></li>
            <li>Tickets to the HR Tech World Party, Paris: <strong>8</strong></li>            
        </ul>
        <div class="Table" id="ContactUs">
        	<h3 class="Category">CONTACT US</h3>
            <div class="Details">
                <p id="PhoneHungary"><img src="img/loyalty-program/phone.png" alt="Phone:" class="PhoneIcon"> +36 1 201 1469</p>
                <p><img src="img/loyalty-program/phone.png" alt="Phone:" class="PhoneIcon"> +44 20 34 689 689</p>
                <p><a href="mailto:hrn@hrneurope.com" title="hrn@hrneurope.com"><img src="img/loyalty-program/envelope.png" alt="Email:" id="EnvelopeIcon"> HRN@HRNEUROPE.COM</a></p>
            </div>
        </div>
    </div>
    <!-- END Gold -->   
...
<section id="FAQ">
    ...
    <h3>All you need to know about our Loyalty Program.</h3>
    <ol id="FAQList">
    	<li><strong>For which events are my tickets valid?</strong>
			<span>Tickets are valid for HR Tech World Congress and iRecruit Would Congress in Paris October 27 and 28.</span></li>
        <li><strong>What is my account manager responsible for?</strong>
            <span>Your account manager is responsible for ensuring you and your team can make the most of your event experience. You will also have a direct line to your account manager for anything you need, whether it’s questions about registration, help with your loyalty scheme, or on-site assistance.</span></li>
        <li><strong>What kind of research will I receive if I am a gold or diamond member?</strong>
            <span>Every quarter you will receive high-level research on the current state of HR technology. Reports contain exhaustive information on the HR technology landscape, and measure the trends and perceived impact on HR.</span></li>
        <li id="FourthFAQ"><strong>Where is the main-stage VIP seating located?</strong>
            <span>Please contact your account manager to discuss your preferred seating options.</span></li>
    	<li><strong>What are the exclusive meeting and networking areas?</strong>
            <span>Gold and diamond members have access to private meeting and networking spaces, away from the commotion of the rest of the conference for a quieter sit down with clients, team members or potential partners. Organized networking opportunities will be available during the breaks and scheduled in 2 weeks before the event date</span></li>
        <li><strong>Can I meet with any of the keynotes taking part in the events?</strong>
            <span>We make every effort to bring together loyalty scheme members with their preferred keynotes, subject to speaker schedules and availability.</span></li>
        <li><strong>What are my branding opportunities?</strong>
            <span>Please contact your account manager to discuss relevant branding opportunities.</span></li>
        <li><strong>What is the HR Tech World Party?</strong>
            <span>The HR Tech World Party is being held in Paris on October 27th, shortly after the end of the conference’s first day. It’s a chance to relax and network with thousands of your colleagues and counterparts in a more informal setting.</span></li>        
    </ol>
</section>
<!--END FAQ --> 
